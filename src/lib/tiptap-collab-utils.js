 ...
 */
export const getNodeDisplayName = editor => {
 ...
 */
export function getElementOverflowPosition(targetElement, containerElement) {
 ...
 */
export const isSelectionValid = (editor, selection, excludedNodeTypes = ["imageUpload", "horizontalRule"]) => {
 ...
 */
export const isTextSelectionValid = editor => {
  if (!editor) return false
  const { state } = editor
