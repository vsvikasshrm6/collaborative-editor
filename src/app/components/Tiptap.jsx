...
useEffect(() => {
    const provider = new TiptapCollabProvider({
      ...
      token: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NTY2NDg4ODgsIm5iZiI6MTc1NjY0ODg4OCwiZXhwIjoxNzU2NzM1Mjg4LCJpc3MiOiJodHRwczovL2Nsb3VkLnRpcHRhcC5kZXYiLCJhdWQiOiJybThkeHgxayJ9.VLzGxApEcfagrVGZ3gJes0remy1uFptd-0GaHm_mLEU", // Your JWT token
      document: doc,
  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Ai.configure({
              appId: 'rm8o2v29',
              token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NTY2NjE5NTcsIm5iZiI6MTc1NjY2MTk1NywiZXhwIjoxNzU2NzQ4MzU3LCJpc3MiOiJodHRwczovL2Nsb3VkLnRpcHRhcC5kZXYiLCJhdWQiOiJkZmVjOGI1ZC1mNTc3LTQyNDEtYTY2Yy02NTRmNmY3NTFlMDkifQ._nAVLwOuA-uEF3x8nruyoJLQJeXOwM7wjBu9u_tI6x8',
              autocompletion: true,
              onLoading: () => {
                setState({
                  isLoading: true,
